...
export default function Page() {
  ...
  useEffect(() => {
    ...
    mm.add("(min-width: 1024px)", () => {
      ...
      const container2 = document.querySelector(".horizontal-scroll-content-2") as HTMLElement;
      if (container2) {
        gsap.to(container2, {
    ...
    <>
      ...
      <main className="flex-grow flex flex-col gap-0 pb-12 bg-surface-container/10">
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-24 pb-12 md:pt-36 md:pb-20 grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center relative overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-7 flex flex-col gap-lg z-10">
            ...
            <h1 className="gsap-hero-animate font-display text-4xl md:text-display-lg uppercase font-bold tracking-tighter text-primary leading-none">
              ...
              <span className="bg-gradient-to-r from-primary via-secondary to-[#6366F1] text-transparent bg-clip-text">Enterprise Scale</span>.
            </h1>
            <p className="gsap-hero-animate font-sans text-md md:text-body-lg text-on-surface-variant max-w-2xl mt-md">
              We architecture, build, and optimize high-performance software systems. Delivering robust technological foundations that drive operational excellence and market dominance.
            </p>

            <div className="gsap-hero-animate flex flex-wrap gap-md mt-lg">
              <Link className="gsap-scale-in bg-primary text-white px-[32px] py-[16px] font-sans text-xs uppercase tracking-widest hover:bg-neutral-800 transition-all border border-primary font-bold rounded-full shadow-md hover:shadow-lg duration-300" href="/services">
                Explore Solutions
              </Link>
              <Link className="gsap-scale-in bg-transparent text-primary px-[32px] py-[16px] font-sans text-xs uppercase tracking-widest hover:bg-neutral-100/80 transition-all border border-neutral-200/80 flex items-center gap-2 font-bold rounded-full shadow-sm duration-300" href="/technologies">
          ...
          <div className="col-span-1 lg:col-span-5 mt-xxl lg:mt-0 z-10">
            <div 
              ...
              className="gsap-hero-animate w-full aspect-[4/3] border border-neutral-200/80 rounded-2xl relative overflow-hidden bg-surface-container-low group shadow-lg hover:shadow-2xl transition-all duration-500 gsap-image-reveal"
            >
              <img 
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12">
          <p className="font-sans text-xs uppercase tracking-widest text-on-surface-variant mb-lg text-center md:text-left font-bold gsap-fade-in">Trusted Infrastructure Partners</p>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-md justify-center items-center">
            {[
              { name: "CORPNET", icon: "dns", color: "hover:text-secondary hover:border-secondary/30" },
              { name: "GLOBALSYS", icon: "language", color: "hover:text-blue-500 hover:border-blue-500/30" },
              { name: "DATACORE", icon: "database", color: "hover:text-amber-500 hover:border-amber-500/30" },
              { name: "NEXUSIT", icon: "hub", color: "hover:text-teal-500 hover:border-teal-500/30" },
              { name: "OMNITECH", icon: "terminal", color: "hover:text-purple-500 hover:border-purple-500/30" }
            ].map((partner, index) => (
              <div key={index} className={`gsap-scale-in flex items-center justify-center gap-sm bg-white/70 backdrop-blur-sm border border-neutral-200/50 rounded-2xl py-4 px-md shadow-sm transition-[border-color,box-shadow] duration-300 hover:shadow-md hover:-translate-y-0.5 group cursor-default ${partner.color}`}>
                <span className="material-symbols-outlined text-neutral-400 group-hover:scale-110 transition-transform duration-300">{partner.icon}</span>
                <span className="font-display text-sm font-bold tracking-tighter text-primary">{partner.name}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 bg-surface rounded-3xl shadow-sm border border-neutral-200/40">
          <div className="flex flex-col md:flex-row justify-between items-end mb-xxl gap-lg px-4 gsap-slide-up">
            <div className="max-w-3xl">
              <span className="font-sans text-xs uppercase tracking-widest text-secondary font-bold block mb-sm">01 // Engineering Solutions</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight text-primary mb-md">Core Competencies</h2>
              <p className="font-sans text-sm md:text-body-lg text-on-surface-variant">Strategic engineering services designed to solve complex architectural challenges and scale enterprise operations.</p>
            </div>
            <Link className="font-sans text-xs uppercase tracking-widest border-b-2 border-primary pb-1 hover:text-secondary hover:border-secondary transition-colors inline-flex items-center gap-2 font-bold" href="/services">
          ...
          <div className="gsap-stagger-scale grid grid-cols-1 md:grid-cols-12 gap-md p-2">
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-sm mb-lg">
                    <span className="material-symbols-outlined text-[32px] text-secondary">architecture</span>
                    <span className="font-sans text-[10px] uppercase tracking-widest border border-neutral-200 px-3 py-1 bg-neutral-50 font-bold rounded-full shadow-sm text-secondary">Primary</span>
                  </div>
                  <h3 className="font-display text-2xl font-bold uppercase text-primary mb-sm">Cloud Architecture & Migration</h3>
                  <p className="font-sans text-sm text-on-surface-variant mb-md leading-relaxed">
                    Designing resilient, scalable cloud infrastructures. Seamlessly migrating legacy systems to modern distributed environments while minimizing downtime.
                  </p>
                  <ul className="space-y-2 mb-lg">
                    {["Multi-Region High Availability Clusters", "Declarative Infrastructure as Code (IaC)", "Self-Healing Container Orchestration"].map((item, idx) => (
                      <li key={idx} className="flex items-center gap-2 font-sans text-xs text-on-surface-variant">
                ...
                <Link href="/services/cloud-infrastructure" className="font-sans text-xs uppercase tracking-widest font-bold text-primary hover:text-secondary inline-flex items-center gap-1 mt-auto">
            ...
            >
              ...
              <div className="flex-grow flex flex-col justify-between">
                <div>
                  <span className="material-symbols-outlined text-[32px] text-secondary mb-md block">security</span>
                  <h3 className="font-display text-xl font-bold uppercase text-primary mb-sm">Cybersecurity</h3>
                  <p className="font-sans text-xs text-on-surface-variant leading-relaxed mb-md">
                    Implementing zero-trust frameworks, strict multi-factor authentication, and proactive threat mitigation protocols for absolute data sovereignty.
                  </p>
                </div>
                <Link href="/services/cybersecurity" className="font-sans text-xs uppercase tracking-widest font-bold text-primary hover:text-secondary inline-flex items-center gap-1 mt-auto">
                  Learn More <span className="material-symbols-outlined text-[14px]">arrow_right_alt</span>
                </Link>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-grow flex flex-col justify-between">
                <div>
                  <span className="material-symbols-outlined text-[32px] text-[#6366F1] mb-md block">memory</span>
                  <h3 className="font-display text-xl font-bold uppercase text-primary mb-sm">AI & Machine Learning</h3>
                  <p className="font-sans text-xs text-on-surface-variant leading-relaxed mb-md">
                    Embedding custom fine-tuned predictive models and autonomous multi-agent loops into operational workflows for data-driven telemetry.
                  </p>
                </div>
                <Link href="/services/ai-machine-learning" className="font-sans text-xs uppercase tracking-widest font-bold text-primary hover:text-secondary inline-flex items-center gap-1 mt-auto">
                  Learn More <span className="material-symbols-outlined text-[14px]">arrow_right_alt</span>
                </Link>
              </div>
            </div>
            ...
            >
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-sm mb-lg">
                    <span className="material-symbols-outlined text-[32px] text-secondary">code_blocks</span>
                  </div>
                  <h3 className="font-display text-2xl font-bold uppercase text-primary mb-sm">Custom Software Engineering</h3>
                  <p className="font-sans text-sm text-on-surface-variant mb-md leading-relaxed">
                    Full-stack engineering of bespoke enterprise systems. Designing scalable, maintainable, and type-safe systems mapped to specific business processes.
                  </p>
                  <ul className="space-y-2 mb-lg">
                    {["Enterprise CRM & ERP Systems", "High-Throughput Relational Databases", "Custom API & Integration Gateways"].map((item, idx) => (
                      <li key={idx} className="flex items-center gap-2 font-sans text-xs text-on-surface-variant">
                        <span className="material-symbols-outlined text-xs text-secondary">check</span>
                        {item}
                      </li>
                ...
                <Link href="/services/website-development" className="font-sans text-xs uppercase tracking-widest font-bold text-primary hover:text-secondary inline-flex items-center gap-1 mt-auto">
                  Learn More <span className="material-symbols-outlined text-[14px]">arrow_right_alt</span>
                </Link>
              </div>
              <div className="w-full md:w-[280px] h-[220px] md:h-auto relative overflow-hidden rounded-xl border border-neutral-200/80 shadow-sm bg-white shrink-0 gsap-image-reveal">
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-16">
          <div className="max-w-3xl mb-xxl gsap-slide-up">
            <span className="font-sans text-xs uppercase tracking-widest bg-gradient-to-r from-secondary to-[#6366F1] text-transparent bg-clip-text font-bold block mb-xs">Execution Roadmap</span>
            <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight text-primary">Process Blueprint</h2>
            <p className="font-sans text-sm md:text-body-lg text-on-surface-variant mt-sm">A structured engineering process guarantees delivery alignment, removing single points of failure at every execution milestone.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl items-start">
            {/* Steps Left List (Sticky Navigation) */}
            <div className="col-span-12 lg:col-span-5 lg:sticky lg:top-[160px] self-start flex flex-col gap-md gsap-stagger-scale relative pl-1">
              {processSteps.map((step, idx) => (
                ...
                >
                  <span className={`font-display text-lg font-bold w-10 h-10 flex items-center justify-center rounded-full shrink-0 transition-all duration-300 ${
                    activeStep === idx 
                  ...
                  <div>
                    <h4 className="font-display text-sm font-bold uppercase text-primary leading-tight tracking-wide transition-colors duration-300">{step.name}</h4>
                    <span className="font-sans text-[10px] text-secondary font-semibold uppercase tracking-wider">{step.metric}</span>
                  </div>
                </button>
              ))}
            </div>
            ...
            <div className="col-span-12 lg:col-span-7 flex flex-col gap-md lg:gap-[80vh] w-full pb-8 lg:pb-12">
              {processSteps.map((step, idx) => (
                <div 
                  ...
                  className={`border border-neutral-200/50 text-primary p-xl rounded-3xl min-h-[420px] flex flex-col justify-between shadow-[0_15px_35px_rgba(0,0,0,0.03)] relative overflow-hidden transition-[border-color,box-shadow] duration-500 ease-out lg:sticky w-full ${
                    activeStep === idx 
                ...
                >
                  ...
                  <div className="absolute inset-0 w-full h-full z-0 overflow-hidden rounded-3xl">
                    <img 
                      ...
                      className={`w-full h-full object-cover transition-all duration-1000 ${
                        activeStep === idx ? "scale-105 opacity-100" : "opacity-90"
                      }`}
                    />
                  ...
                  <div className="relative z-10 flex flex-col justify-between flex-grow h-full gap-lg">
                    ...
                    <div className="bg-white/80 backdrop-blur-md border border-white/60 p-lg rounded-2xl max-w-xl shadow-lg relative z-10 flex flex-col gap-md">
                      <div className="flex items-center gap-md">
                        <span className="material-symbols-outlined text-[32px] text-secondary bg-secondary/5 p-2 rounded-xl border border-secondary/10 shadow-sm">{step.icon}</span>
                        <span className="font-sans text-[10px] uppercase tracking-widest text-[#6366F1] font-extrabold bg-[#6366F1]/10 px-3 py-1 rounded-full border border-[#6366F1]/20">PHASE {step.phase}</span>
                      </div>
                  ...
                  <div className="mt-xl pt-md flex justify-between items-center relative z-10 bg-white/80 backdrop-blur-md -mx-xl -mb-xl p-md px-xl rounded-b-3xl border-t border-neutral-200/40">
                    <div className="flex items-center gap-xs">
                      ...
                      <span className="font-sans text-[10px] uppercase text-secondary font-bold tracking-widest">Metric Verification Indicator</span>
                    </div>
        ...
        <div>
          ...
          <div className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop mb-lg relative z-10 shrink-0">
            ...
            <p className="font-sans text-sm text-neutral-400 mt-xs max-w-xl">
              Observe real-world implementations of our high-throughput systems, zero-latency API ledgers, and predictive twins.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-md">
                    <div className="flex justify-between items-center border-b border-neutral-800 pb-sm">
                      ...
                      <span className="font-sans text-[10px] bg-secondary/15 text-secondary border border-secondary/25 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">{panel.metric}</span>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-xs mt-lg pt-sm z-10">
                    {panel.tags.map((tag, tIdx) => (
                      <span key={tIdx} className="font-sans text-[9px] uppercase tracking-wider font-semibold text-neutral-400 bg-neutral-900 border border-neutral-800 px-2 py-0.5 rounded-full">{tag}</span>
                    ))}
                  </div>
                </div>
              ))}
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-xxl gap-lg gsap-slide-up">
            <div className="max-w-2xl">
              <span className="font-sans text-xs uppercase tracking-widest bg-gradient-to-r from-secondary to-[#6366F1] text-transparent bg-clip-text font-bold block mb-xs">Our Engineering Core</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight text-primary">Technology Catalog</h2>
              <p className="font-sans text-sm md:text-body-lg text-on-surface-variant mt-sm">Filter our verified system catalog modules by architectural stack domains.</p>
            </div>
              ...
              >
                ...
                <div>
                  <div className="flex justify-between items-center mb-md">
                    <span className="font-display text-lg font-bold text-primary">{node.name}</span>
                    <span className="font-sans text-[9px] uppercase tracking-wider text-secondary border border-secondary/20 px-2 py-0.5 rounded-full font-bold bg-secondary/5">{node.level}</span>
                  </div>
                  <p className="font-sans text-xs text-neutral-400 leading-relaxed">{node.desc}</p>
                </div>
                <div className="mt-lg pt-md border-t border-neutral-200/80 flex items-center justify-between">
                  <span className="font-sans text-[10px] text-neutral-500 uppercase tracking-widest font-bold">Standard Spec</span>
                  <span className="material-symbols-outlined text-sm text-neutral-700 group-hover:text-secondary transition-colors">check_circle</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop mb-lg relative z-10 shrink-0">
            ...
            <p className="font-sans text-sm text-on-surface-variant mt-xs max-w-xl">
              We build specialized, compliant technology architectures tailored to scale vertical-specific business modules.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-md">
                    <div className="flex justify-between items-center border-b border-neutral-100 pb-sm">
                      <span className="font-mono text-xs text-neutral-400 font-semibold">VERTICAL_{index + 1}</span>
                      <span className={`font-sans text-[10px] bg-neutral-150 ${vertical.themeColor} border border-neutral-200/60 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider`}>{vertical.metric}</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center mt-lg pt-sm z-10">
                    <div className="flex flex-wrap gap-xs">
                      {vertical.features.slice(0, 1).map((feature, fIdx) => (
                        <span key={fIdx} className="font-sans text-[9px] uppercase tracking-wider font-semibold text-neutral-500 bg-neutral-50 border border-neutral-100 px-2.5 py-0.5 rounded-full">{feature}</span>
                      ))}
                    </div>
                    <Link href={vertical.link} className="font-sans text-[10px] uppercase tracking-widest font-extrabold text-primary hover:text-secondary inline-flex items-center gap-1">
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 rounded-3xl bg-white shadow-sm border border-neutral-200/60">
          <div className="flex flex-col md:flex-row justify-between items-end mb-xxl gap-lg px-4 gsap-slide-up">
            <div className="max-w-3xl">
              <span className="font-sans text-xs uppercase tracking-widest text-secondary font-bold block mb-sm">04 // Engineering Divisions</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight text-primary font-bold">Enterprise Engineering Divisions</h2>
              <p className="font-sans text-sm md:text-body-lg text-on-surface-variant">Our specialized technical teams audit active server clusters and deploy resilient scaling models.</p>
            </div>
            <Link className="font-sans text-xs uppercase tracking-widest border-b-2 border-primary pb-1 hover:text-secondary hover:border-secondary transition-colors inline-flex items-center gap-2 font-bold" href="/about">
              Our Operations <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </Link>
          </div>
          ...
          <div className="gsap-stagger-scale grid grid-cols-1 md:grid-cols-3 gap-md p-2">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="font-display text-lg font-bold uppercase text-primary mb-xs">{member.name}</h3>
                  <span className="font-sans text-xs text-secondary font-bold uppercase tracking-wider block mb-sm">{member.role}</span>
                  <p className="font-sans text-xs text-on-surface-variant leading-relaxed mb-md">{member.desc}</p>
                </div>
                <div className="pt-sm border-t border-neutral-100 flex items-center justify-between">
                  <span className="font-mono text-[9px] text-neutral-450 font-bold">VERIFIED_SPECIALIST</span>
                  <span className="material-symbols-outlined text-sm text-neutral-450 group-hover:text-secondary transition-colors">verified</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 bg-white/60 backdrop-blur-md rounded-3xl shadow-md border border-neutral-200/80">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-md">
            {[
              { value: "99.99%", label: "Uptime SLA Delivered", icon: "cloud_done", desc: "Guaranteed high availability clusters" },
              { value: "150+", label: "Enterprise Deployments", icon: "rocket_launch", desc: "Validated production infrastructures" },
              { value: "<45ms", label: "Avg Latency Reduction", icon: "speed", desc: "Sub-millisecond API execution times" },
              { value: "24/7", label: "Continuous Monitoring", icon: "monitoring", desc: "Active telemetry and warning sensors" }
            ].map((stat, index) => (
              <div key={index} className="gsap-scale-in flex flex-col items-center p-lg text-center bg-white border border-neutral-200/80 hover:border-secondary/40 text-primary rounded-2xl shadow-sm hover:shadow-[0_8px_30px_rgba(203,41,87,0.12)] hover:-translate-y-1 transition-[border-color,box-shadow] duration-300">
                <span className="material-symbols-outlined text-secondary text-2xl mb-sm">{stat.icon}</span>
                <span className="font-display text-3xl md:text-4xl font-extrabold text-primary mb-xs">{stat.value}</span>
                <span className="font-sans text-[11px] uppercase tracking-widest text-primary font-bold mb-xs">{stat.label}</span>
                <span className="font-sans text-[10px] text-on-surface-variant">{stat.desc}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-16">
          <div className="max-w-3xl mb-xxl gsap-slide-up">
            <span className="font-sans text-xs uppercase tracking-widest text-secondary font-bold block mb-sm">05 // Architectural Simulator</span>
            <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight text-primary">Systems Telemetry Sandbox</h2>
            <p className="font-sans text-sm md:text-body-lg text-on-surface-variant">Observe live packet forwarding routes and node health warnings across our simulated high-throughput load balancer.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg items-stretch">
              ...
              <div>
                <div className="flex justify-between items-center border-b border-neutral-800 pb-sm mb-lg">
                  <div className="flex items-center gap-xs">
                    ...
                    <span className="font-mono text-xs text-neutral-450 ml-sm font-semibold">load-balancer-routing.config</span>
                  </div>
                  <span className="font-sans text-[10px] bg-secondary/15 text-secondary px-3 py-0.5 rounded-full font-bold tracking-widest uppercase animate-pulse">Running</span>
                </div>
            ...
            <div className="col-span-12 lg:col-span-5 flex flex-col gap-md">
              <div className="border border-neutral-200/80 p-lg bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between flex-grow">
                <div>
                  <span className="material-symbols-outlined text-secondary text-[36px] mb-md block">schema</span>
                  <h4 className="font-display text-lg font-bold uppercase text-primary mb-xs">Deterministic Load Balancer</h4>
                ...
                <div className="mt-lg pt-sm border-t border-neutral-100 flex items-center justify-between">
                  ...
                  <span className="font-sans text-[10px] bg-secondary/5 text-secondary border border-secondary/15 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Active</span>
                </div>
              </div>

              <div className="border border-neutral-200/80 p-lg bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between flex-grow">
                <div>
                  <span className="material-symbols-outlined text-[#6366F1] text-[36px] mb-md block">network_node</span>
                  <h4 className="font-display text-lg font-bold uppercase text-primary mb-xs">State Machine Reconciliation</h4>
                  <p className="font-sans text-xs text-on-surface-variant leading-relaxed">
                ...
                <div className="mt-lg pt-sm border-t border-neutral-100 flex items-center justify-between">
                  ...
                  <span className="font-sans text-[10px] bg-secondary/5 text-secondary border border-secondary/15 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Verified</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mx-4 md:mx-margin-desktop max-w-container-max md:w-[calc(100%-128px)] bg-primary text-white text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-xl p-lg md:p-[64px] rounded-3xl shadow-xl my-4 border border-neutral-800 relative overflow-hidden self-center">
          ...
          <div className="max-w-2xl relative z-10 gsap-slide-up">
            <h2 className="font-display text-3xl md:text-4xl font-bold uppercase tracking-tight mb-md">Ready to optimize your infrastructure?</h2>
            <p className="font-sans text-md text-surface-dim">Engage with our senior engineering team to audit your current architecture and chart a path to scalable efficiency.</p>
          </div>
          <div className="relative z-10 shrink-0 gsap-scale-in">
            <Link className="accent-bg px-[32px] py-[16px] font-sans text-xs uppercase tracking-widest hover:bg-white hover:text-primary transition-all border border-transparent hover:border-primary inline-flex items-center gap-2 font-bold text-center rounded-full shadow-md hover:scale-[1.02] active:scale-[0.98]" href="/contact">
              Request Architecture Audit <span className="material-symbols-outlined">arrow_forward</span>
            </Link>
          </div>
        </section>
      </main>
