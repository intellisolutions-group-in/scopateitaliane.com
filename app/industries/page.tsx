...
export default function Page() {
  ...
  return (
    <>
      <Navbar />
      <main className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-xxl space-y-huge bg-surface-container/10">
        ...
        <section className="gsap-stagger-container grid grid-cols-12 gap-gutter items-center mb-huge pt-28 pb-12 md:pt-36 md:pb-20 relative overflow-hidden">
          ...
          <div className="col-span-12 md:col-span-8 z-10">
            <h1 className="gsap-hero-animate font-display text-5xl md:text-display-lg uppercase font-bold tracking-tighter text-primary leading-none mb-md">
